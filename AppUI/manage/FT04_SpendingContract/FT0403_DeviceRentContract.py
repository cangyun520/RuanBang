...
class DeviceRentContract(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/SpendingContract$Menu"]/li[3]')
    ...
    def test_0403_01_add(self):
        ...
        if "租赁合同" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Spending/test_0403_01_add.png")
