...
class PaymentRegister(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/InvoiceManager$Menu"]/li[4]')
    ...
    def test_0704_01_add(self):
        ...
        if "付款登记" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Invoice/test_0704_01_add.png")
            unittest.expectedFailure("test_0704_01_add")
