...
class InvoiceRegister(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/InvoiceManager$Menu"]/li[1]')
    ...
    def test_0701_01_add(self):
        ...
        if "开票登记" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Invoice/test_0701_01_add.png")
