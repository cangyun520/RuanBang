...
class AcceptingParameter(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/TemporaryManagement$Menu"]/li[8]')
    ...
    def test_0808_01_add(self):
        ...
        if "用工台账" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Temporary/test_0808_01_add.png")
