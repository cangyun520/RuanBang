...
class ReturnsMaterialRegister(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/StorageManager$Menu"]/li[4]')
    ...
    def test_0504_01_add(self):
        ...
        if "退料登记" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Storage/test_0504_01_add.png")
