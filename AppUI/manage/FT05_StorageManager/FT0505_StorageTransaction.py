...
class StorageTransaction(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/StorageManager$Menu"]/li[5]')
    ...
    def test_0505_01_add(self):
        ...
        if "仓库调拨" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Storage/test_0505_01_add.png")
