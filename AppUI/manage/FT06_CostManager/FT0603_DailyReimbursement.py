...
class DailyReimbursement(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/CostManager$Menu"]/li[3]')
    ...
    def test_0603_01_add(self):
        ...
        if "日常报销" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Cost/test_0603_01_add.png")
