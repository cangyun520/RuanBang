...
class BorrowingApply(unittest.TestCase):
    def setUp(self):
        ...
        WebMenu.menu(self, '//*[@id="/manage/CostManager$Menu"]/li[2]')
    ...
    def test_0602_01_add(self):
        ...
        if "借款申请" in cy_check.text:
            print(cy_check)
        else:
            dr.get_screenshot_as_file(SCREENSHOT_PATH + "Cost/test_0602_01_add.png")
